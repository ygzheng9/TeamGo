...
class TaskTypesControllerTest < ActionController::TestCase
  ...
  test "should create task_type" do
    assert_difference('TaskType.count') do
      post :create, task_type: { code: @task_type.code, company_id: @task_type.company_id, desc: @task_type.desc, display_seq: @task_type.display_seq, name: @task_type.name, parent_id: @task_type.parent_id, teammember_id: @task_type.teammember_id }
    end
  ...
  test "should update task_type" do
    patch :update, id: @task_type, task_type: { code: @task_type.code, company_id: @task_type.company_id, desc: @task_type.desc, display_seq: @task_type.display_seq, name: @task_type.name, parent_id: @task_type.parent_id, teammember_id: @task_type.teammember_id }
    assert_redirected_to task_type_path(assigns(:task_type))
  end
